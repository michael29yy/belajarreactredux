...
const EditKaryawan = () => {
    ...
    useEffect(() => {
        if (getDetailKaryawanResult) {
            setIdKry(getDetailKaryawanResult.id)
            setUsername(getDetailKaryawanResult.username)
            setNama(getDetailKaryawanResult.nama)
            setBiro(getDetailKaryawanResult.biro)
            setTeamBiro(getDetailKaryawanResult.teambiro)
            setHobi(getDetailKaryawanResult.hobi)
            setPassword(getDetailKaryawanResult.password)
        }
    }, [getDetailKaryawanResult])
